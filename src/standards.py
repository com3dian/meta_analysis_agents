    ...
    "wopke_100": """
{
    ...
    "Sowing date 2": "Date when Crop species 2 (the second species listed in the intercropping system) was sown. Example: Glycine max sown 20 April 2019. If not reported, set to null.",
    "Harvest date 1": "Date when Crop species 1 (the first species listed in the intercropping system) was harvested. Example: Zea mays harvested 10 September 2019. If not reported, set to null.",
    "Harvest date 2": "Date when Crop species 2 (the second species listed in the intercropping system) was harvested. Example: Glycine max harvested 25 August 2019. If not reported, set to null.",
    "TND": "Temporal Niche Differentiation index if explicitly reported in the paper. Example: 0.25. If not explicitly reported, set to null.",
    "Lat": "Latitude of the experimental site in decimal degrees. Example: 35.12. If not reported, set to null.",
    "Lon": "Longitude of the experimental site in decimal degrees. Example: -1.56. If not reported, set to null.",
    "Continent": "Continent of the experimental site. Example: Asia. If not reported, set to null.",
    "Crop species 1": "Common or scientific name of the first crop species in the intercropping system. Example: Wheat or Triticum aestivum.",
    "Crop species 2": "Common or scientific name of the second crop species in the intercropping system. Example: Soybean or Glycine max.",
    ...
    "Fodder crop 1": "Set to 1 (or true) if Crop species 1 is grown for fodder/forage/biomass; set to 0 (or false) if grown for grain/seed harvest.",
    "Fodder crop 2": "Set to 1 (or true) if Crop species 2 is grown for fodder/forage/biomass; set to 0 (or false) if grown for grain/seed harvest.",
    ...
    "Density ic 1": "Plant density of Crop species 1 in the intercropping treatment. Example: 5. If not reported, set to null.",
    "Density ic 2": "Plant density of Crop species 2 in the intercropping treatment. Example: 20. If not reported, set to null.",
    "Density sc 1": "Plant density of Crop species 1 when grown as a sole crop (monoculture). Example: 8. If not reported, set to null.",
    "Density sc 2": "Plant density of Crop species 2 when grown as a sole crop (monoculture). Example: 30. If not reported, set to null.",
    "RDT": "Relative Density Total of the intercrop system if explicitly reported in the paper. Example: 1.0. If not reported, set to null.",
    "N input SC1": "Nitrogen fertilizer applied to the sole crop treatment of Crop species 1. Example: 120. If not reported, set to null.",
    "N input SC2": "Nitrogen fertilizer applied to the sole crop treatment of Crop species 2. Example: 30. If not reported, set to null.",
    "N input IC1": "Nitrogen fertilizer attributed to Crop species 1 in the intercropping treatment. Example: 60. If not reported, set to null.",
    "N input IC2": "Nitrogen fertilizer attributed to Crop species 2 in the intercropping treatment. Example: 30. If not reported, set to null.",
    "N total in IC": "Total nitrogen fertilizer applied in the intercropping treatment. Example: 90. If not reported, set to null.",
    "N Unit": "Unit used for nitrogen fertilizer amounts. Example: kg N ha−1. If not reported, set to null.",
    "Replications SC1": "Number of replicates for sole crop treatment 1. Example: 4. If not reported in the paper, set to null.",
    "Replications SC2": "Number of replicates for sole crop treatment 2. Example: 4. If not reported in the paper, set to null.",
    "Replications IC1": "Number of replicates for intercrop treatment 1. Example: 4. If not reported in the paper, set to null.",
    "Replications IC2": "Number of replicates for intercrop treatment 2. Example: 4. If not reported in the paper, set to null.",
    "Data source": "Location of the extracted data within the publication. Example: Table 1,2; Figure 3; Supplementary Table S1.",
    "unified yield sc 1": "Yield of Crop species 1 grown as a sole crop. For grain crops, extract grain yield; for fodder/forage crops, extract total above-ground dry matter (DM) or biomass yield. Example: 8.5. If not reported, set to null.",
    "unified yield sc 2": "Yield of Crop species 2 grown as a sole crop. For grain crops, extract grain yield; for fodder/forage crops, extract total above-ground dry matter (DM) or biomass yield. Example: 2.4. If not reported, set to null.",
    "unified yield ic 1": "Intercrop yield of Crop species 1 in the common Yield unit (grain yield for grain crops, or total dry matter / biomass yield for fodder crops). If multi-cut forage, extract total seasonal cumulative yield across cuts. Example: 3.4. If not reported, set to null.",
    "unified yield ic 2": "Intercrop yield of Crop species 2 in the common Yield unit (grain yield for grain crops, or total dry matter / biomass yield for fodder crops). If multi-cut forage, extract total seasonal cumulative yield across cuts. Example: 1.4. If not reported, set to null.",
    "Yield unit": "Common unit for all unified yield fields on this record (e.g., t/ha, kg/ha, g/m2, or g DM/m2). Ensure sole crop and intercrop yields for the same species use identical units. If not reported, set to null.",
    "PLER 1": "Partial Land Equivalent Ratio of Crop species 1 if explicitly reported in the paper. Example: 0.72. If not reported, set to null.",
    "PLER 2": "Partial Land Equivalent Ratio of Crop species 2 if explicitly reported in the paper. Example: 0.53. If not reported, set to null.",
    "LER": "Total Land Equivalent Ratio of the intercropping treatment if explicitly reported in the paper. Example: 1.25. If not reported, set to null."
}
""",
